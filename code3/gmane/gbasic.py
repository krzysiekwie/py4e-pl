...
howmany = int(input("Ile wyświetlić? "))
...
print("Załadowanych wiadomości=",len(messages),"tematów=",len(subjects),"nadawców=",len(senders))
...
print('')
print('Lista',howmany,'najczęstszych użytkowników')
...
print('')
print('Lista',howmany,'najczęstszych organizacji')
