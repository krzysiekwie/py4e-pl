...
#    e) w kolejnym kroku opisz po angielsku, jak zamierzasz wykorzystać 
#       dane Twittera (wspomnij, że uczysz się Pythona, chcesz 
#       dowiedzieć się, jak korzystać z API Twittera, zamierzasz napisać 
#       dwa mini-projekty, które w interaktywny sposób pobierają nazwę 
#       konta Twittera i dla podanego konta w projekcie nr 1 pobierzesz i 
#       wyświetlisz oś czasu użytkownika zwróconą w formacie JSON, 
#       a w projekcie nr 2 pobierzesz listę jego znajomych w formacie JSON
#       i przeparsujesz ją w celu wyciągnięcia informacji o znajomych;
#       opisz tę sekcję dość szczegółowo, gdyż wpływa ona na akceptację
#       Twojego zgłoszenia); w sekcji "Specifics" zaznacz wszystko na "No"
...
# 4. Utwórz aplikację, w karcie "Keys and tokens" wygeneruj klucze 
#    i podmień poniżej cztery ciągi znaków dotyczące consumer_key, 
#    consumer_secret, token_key i token_secret (podmień wszystko, co 
#    znajduje się między cudzysłowami, łącznie z nawiasami ostrokątnymi)
